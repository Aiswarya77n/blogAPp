...
export default function Navbar() {
  ...
  const isNotMenuOpen = Boolean(anchorElNot);
                  ...
                  {notifications?.map(
                    (notification) => (
                      (
                        ...
                        >
                          {notification.sender} {notification.type} your post{" "}
